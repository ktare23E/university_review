...
class UniversityControllers extends University{
    ...
    public function insertUniversityCourseControllers($university_college_id,$course_id,$status,$tuition_per_sem){
        $this->universityCourse($university_college_id,$course_id,$status,$tuition_per_sem);
    }
    ...
    public function updateUniversityCourseControllers($university_course_id,$university_college_id,$course_id,$status){
        return $this->updateUniversityCourse($university_course_id,$university_college_id,$course_id,$status);
    }
