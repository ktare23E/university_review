...
(1,'NMSC','Labuyo,Tangub City','nmsc@nmsc.edu.ph','Active','skwela na','',NULL,'nmsc.jpg'),
(2,'GADTC','Maloro,Tangub City','gadtc@gadtc.edu.ph','Active','skwela ta dre ','',NULL,'gadtc.jpg'),
...
(7,'Medina Foundation College of Sapang Dalaga, Inc.','Sapang Dalaga','medin@medina.edu.ph','Active','MEdina','Priavate',NULL,'medina.png');
