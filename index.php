...
<body>
    <div class="w-screen h-screen bg-green-50 flex items-center justify-center"> <!-- Centering the whole page content -->
        <div class="w-[70%] mx-auto bg-white p-10 rounded-lg shadow-lg"> <!-- Added padding, rounded corners, and shadow -->
            ...
            <div class="main_content grid grid-cols-3 gap-4"> <!-- Adjusted gap for better spacing -->
                <!-- Card Example (repeated 3 times) -->
                <div class="bg-white border border-gray-200 rounded-lg shadow overflow-hidden"> <!-- Simplified card container -->
                    <a href="#">
                        <img class="w-full h-40 object-cover" src="imgs/nmsc.jpg" alt="" /> <!-- Ensured image covers card top evenly -->
                    </a>
                    <div class="p-5">
                        <a href="#">
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow overflow-hidden"> <!-- Simplified card container -->
                    <a href="#">
                        <img class="w-full h-40 object-cover" src="imgs/gadtc.jpg" alt="" /> <!-- Ensured image covers card top evenly -->
                    </a>
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Noteworthy technology acquisitions 2021</h5>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow overflow-hidden"> <!-- Simplified card container -->
                    <a href="#">
                        <img class="w-full h-40 object-cover" src="imgs/mu.jpg" alt="" /> <!-- Ensured image covers card top evenly -->
                    </a>
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Noteworthy technology acquisitions 2021</h5>
                ...
                <!-- Repeat other cards with necessary modifications -->
            </div>
        </div>
    </div>
</body>
